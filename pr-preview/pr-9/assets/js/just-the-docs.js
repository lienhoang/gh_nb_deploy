...
function initSearch() {
  ...
  request.open('GET', '/gh_nb_deploy/pr-preview/pr-9/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/gh_nb_deploy/pr-preview/pr-9/assets/css/just-the-docs-' + theme + '.css');
}
